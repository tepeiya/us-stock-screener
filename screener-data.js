...
const HEDGE_FUND_13F = {
  bill_ackman: {
    ...
    portfolio_value: '$16B',
    top_buys: [{ticker:'GOOGL',amount:'+$520M'},{ticker:'NKE',amount:'+$180M'},{ticker:'CMG',amount:'+$95M'}],
    top_sells: [{ticker:'PSHZF',amount:'-$210M'}],
  ...
  ray_dalio: {
    ...
    top_sells: [{ticker:'KO',amount:'-$185M'},{ticker:'PEP',amount:'-$142M'},{ticker:'PG',amount:'-$98M'}],
    last_updated: '2026-Q1'
  },
  david_einhorn: {
    name: 'David Einhorn',
    ...
    top_sells: [{ticker:'ODFL',amount:'-$35M'}],
    last_updated: '2026-Q1'
  },
  howard_marks: {
    name: 'Howard Marks',
    ...
    top_buys: [{ticker:'CSCO',amount:'+$135M'},{ticker:'BA',amount:'+$98M'},{ticker:'IBM',amount:'+$72M'}],
    top_sells: [],
    last_updated: '2026-Q1'
  },
  warren_buffett: {
    ...
    top_sells: [{ticker:'AAPL',amount:'-$1.2B'}],
    last_updated: '2026-Q1'
  },
  jim_simons: {
    ...
    positions: 3213,
    top_buys: [{ticker:'AAPL',amount:'+$781M',shares:'3.2M'},{ticker:'NVDA',amount:'+$278M',shares:'1.1M'},{ticker:'LIN',amount:'+$258M',shares:'520K'},{ticker:'AVGO',amount:'+$245M',shares:'560K'},{ticker:'AGI',amount:'+$227M',shares:'8.5M'},{ticker:'JPM',amount:'+$202M',shares:'670K'}],
    top_sells: [{ticker:'NFLX',amount:'-$673M',shares:'1.2M'},{ticker:'COST',amount:'-$578M',shares:'560K'},{ticker:'PLTR',amount:'-$542M',shares:'4.1M'},{ticker:'TSLA',amount:'-$534M',shares:'1.5M'},{ticker:'PG',amount:'-$428M',shares:'2.8M'},{ticker:'MSFT',amount:'-$329M',shares:'800K'}],
    last_updated: '2026-Q1'
  },
  chase_coleman: {
    name: 'Chase Coleman',
    ...
    top_sells: [{ticker:'SE',amount:'-$195M'},{ticker:'COIN',amount:'-$120M'}],
    last_updated: '2026-Q1'
  },
  daniel_loeb: {
    name: 'Daniel Loeb',
    ...
    top_sells: [{ticker:'BAC',amount:'-$95M'}],
    last_updated: '2026-Q1'
  },
  ken_griffin: {
    name: 'Ken Griffin',
    ...
    top_sells: [{ticker:'AAPL',amount:'-$380M'},{ticker:'TSLA',amount:'-$270M'}],
    last_updated: '2026-Q1'
  },
  steve_cohen: {
    name: 'Steve Cohen',
    ...
    top_sells: [{ticker:'AAPL',amount:'-$120M'},{ticker:'DIS',amount:'-$85M'}],
    last_updated: '2026-Q1'
  },
  david_tepper: {
    name: 'David Tepper',
    ...
    top_sells: [{ticker:'GOOGL',amount:'-$75M'},{ticker:'AMD',amount:'-$52M'}],
    last_updated: '2026-Q1'
  },
  nelson_peltz: {
    name: 'Nelson Peltz',
    ...
    top_sells: [{ticker:'KO',amount:'-$45M'}],
    last_updated: '2026-Q1'
  }
};
